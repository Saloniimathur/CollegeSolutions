...
urlpatterns = [
    ...
    path('save_pt_meeting/', views.save_pt_meeting, name='save_pt_meeting'),
    ...
    path('staff/PT/take/', staff_views.staff_take_pt, name='staff_take_pt'),
    path("staff/PT/view", staff_views.staff_view_pt, name='staff_view_pt'),
